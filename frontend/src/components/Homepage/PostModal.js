    ...
    >
      ...
      <AnimatePresence>
        <motion.article
          ...
          className="h-[100%] w-[90%] lg:w-[70%] bg-neutral-900  relative rounded-md p-4 overflow-scroll scrollbar-hide"
        >
          <button
          ...
          >
            ...
            >
              <div className="lg:w-[6%] xl:w-[4%] w-[10%] md:[4%]  p-1 pr-2">
                <img
                  className="h-[70%] w-full  rounded-full object-cover bg-red-300"
