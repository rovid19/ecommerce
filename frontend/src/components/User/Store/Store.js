...
const Store = () => {
  ...
  return (
    <>
      <main className="w-[100%]  skrin flex justify-center relative  ">
        {isFetching && (
                ...
                if (index === 0) {
                  return (
                    <article key={index} className="h-full relative">
                      ...
                      <div className="h-[calc(100%-40px)] w-full grid grid-cols-6 gap-4  border-r-2 border-l-2 border-gray-300 border-opacity-20 p-4 bg-gray-50  ">
                        {item &&
      ...
      {productCollections.length > 2 && (
        <section className="h-screen grid grid-rows-2 bg-whitew-full place-items-center">
