    ...
    <>
      <header className="flex h-[70px] ">
        <div className="w-[75%] flex  items-center ">
          ...
          <div className="h-[60%] w-[70%]  flex items-center rounded-3xl border-2 border-gray-300 border-opacity-25 ">
            <div className="w-full h-full flex justify-between items-center">
              <label className="w-[10%] h-[70%] flex justify-center border-r-2 border-gray-300 border-opacity-30 ">
              ...
              <button className="w-[10%] flex items-center gap-2 ml-4  rounded-2xl h-[90%] mr-1 justify-center text-white bg-orange">
                {" "}
                <svg
